...
const QUICK_LINKS = [
  ...
  { label: 'Attendance', to: '/attendance', Icon: LuClipboardList, color: 'from-rose-800 to-orange-600' },
  { label: 'Tithes', to: '/tithes', Icon: FaCross, color: 'from-amber-700 to-yellow-600' },
  { label: 'Welfare', to: '/welfare', Icon: FaHeart, color: 'from-emerald-800 to-teal-600' },
  { label: 'Reports', to: '/reports', Icon: FaChartBar, color: 'from-violet-800 to-fuchsia-600' },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        {STATS.map(({ label, value, Icon, bg, border, text }) => (
